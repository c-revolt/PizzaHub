...
@admin_router.message(F.text == "Показать ассортимент")
...
async def cancel_handler(message: types.Message, state: FSMContext) -> None:
    ...
    if current_state == AddProduct.name:
        await message.answer('Предыдушего шага нет. Введите название товара и нажмите "отмена".')
        return
...
async def add_name(message: types.Message, state: FSMContext):
    await message.answer("⛔️ Вы ввели недопустимые данные. Нужно ввести текст названия товара.")
...
async def add_description(message: types.Message, state: FSMContext):
    await message.answer("⛔️ Вы ввели недопустимые данные. Нужно ввести текст описания товара.")
...
async def add_price(message: types.Message, state: FSMContext):
    await message.answer("⛔️ Вы ввели недопустимые данные. Нужно ввести стоимость товара.")
